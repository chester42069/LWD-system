...
function getBotResponse(input) {
    ...
    if (input.includes("hi") || input.includes("hello") || input.includes("good morning") || input.includes("hey") || input.incl) {
    ...
    // --- 2. OFFICE HOURS & CONTACT (Source: Page 22) ---
    ...
    // --- 3. COMPLAINTS HANDLING (Source: Page 8-9) ---
    ...
    // --- 4. WATER ANALYSIS (Source: Page 11) ---
    ...
    // --- 5. INFORMATION & QUERIES (Source: Page 10) ---
    ...
    // --- 6. CAREERS & RECRUITMENT (Source: Recruitment Image) ---
    ...
    // --- 7. HISTORY & PARTNERSHIP (Source: Page 2) ---
    ...
    // --- 8. MISSION, VISION, MANDATE (Source: Page 4-5) ---
    ...
    // --- 9. FEEDBACK & COMPLAINTS MECHANISM (Source: Page 20) ---
    ...
    // --- 10. LEADERSHIP ---
    if (input.includes("manager") || input.includes("joel lapis")) {
        return "LWD is headed by <b>Engr. Joel M. Lapis</b>, General Manager.";
    }

    // --- 11. INTERNAL SERVICES (Source: Pages 13-19) ---
    ...
    // --- LWD vs LARC / LAGUNA AQUATECH DIFFERENCE ---
    if (input.includes("difference") || (input.includes("lwd") || input.includes("larc") || input.includes("aquatech"))) {
        return `<b>Difference between LWD and Laguna Aquatech (LARC):</b><br><br>
                • <b>LWD (Laguna Water District):</b> The government-owned agency that owns the assets and acts as the <b>Contract Monitoring Unit (CMU)</b>. They ensure the private partner follows the rules.<br><br>
                • <b>Laguna Aquatech (formerly LARC):</b> The <b>Private Partner/Operator</b>. Since July 2024, they are managed by Manila Water Philippine Ventures (MWPV) and handle the actual water distribution, billing, and maintenance.`;
    }
